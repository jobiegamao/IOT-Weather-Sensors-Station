def warningMessages():
    ...
    if temp <= 20:
        ...
        message = "Caution: Moderately High Heat. Fatigue is possible with prolonged exposure and activity. Continuing activity could result in heat cramps"
    ...
    #----- air pressure-----
    if ap <= 500:
        message = "Caution: The atmospheric pressure is low, so take it easy and don't forget to drink lots of water."
